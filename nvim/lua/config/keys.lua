...
vim.keymap.set('n', '<esc>', ':noh<return>', {noremap = true})
vim.keymap.set('n', '<leader>n', ':set relativenumber! relativenumber?<CR>', {noremap = true, desc = 'Toggle [r]elative number'})
...
end, { desc = '[S]earch by Grep with hidden file[S]' })
...
export.on_attach = function(_, bufnr)
